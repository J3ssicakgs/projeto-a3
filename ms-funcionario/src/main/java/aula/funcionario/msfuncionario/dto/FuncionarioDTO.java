...
public class FuncionarioDTO {
    ...
    public FuncionarioDTO(Funcionario2 funcionario) {
    ...
    public Funcionario2 converteFuncionario(){
    ...
    public static List<FuncionarioDTO> converteListaDTO(List<Funcionario2> funcionarioList){
        List<FuncionarioDTO> dtos = new ArrayList<>();
        for (Funcionario2 funcionario :
                funcionarioList) {
